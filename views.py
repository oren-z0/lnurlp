...
from . import lnurlp_nostr_ext, lnurlp_renderer
from .crud import get_pay_link

templates = Jinja2Templates(directory="templates")


@lnurlp_nostr_ext.get("/", response_class=HTMLResponse)
...
@lnurlp_nostr_ext.get("/link/{link_id}", response_class=HTMLResponse)
...
@lnurlp_nostr_ext.get("/print/{link_id}", response_class=HTMLResponse)
